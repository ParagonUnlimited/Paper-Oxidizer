...
This Code of Conduct applies within all community spaces — the issue
tracker, pull requests, code reviews, chat, and any other communication
channel — and also applies when an individual is representing the project
...
reported to the maintainers at `businessleadership@paragonunlimited.pro`.
